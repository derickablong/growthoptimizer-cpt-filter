...
final class GO_2C_SIDEBAR_FILTER_ARTICLE {
	 ...
	 * @access public
	 */
	public function i18n() { load_plugin_textdomain( 'elementor-test-extension' ); }
	...
	public function init() {				
		// Add Plugin actions		
		add_action( 'elementor/widgets/widgets_registered', [ $this, 'enqueue_styles' ] );	
